...
def create_comprehensive_dashboard():
    ...
    fig = make_subplots(
        ...
        subplot_titles=[
            ...
            'Storage duration per technology',
            'Summary Table'
        ],
        specs=[
    ...
    # Typical storage durations in hours
    storage_durations = {'PHS': 6, 'battery': 4, 'ironair': 100, 'H2': 720}  # Hours
    ...
    fig.add_trace(go.Bar(
        ...
        text=[f'{dur}h' for dur in duration_values],
        textposition='outside',
        hovertemplate='<b>%{x}</b><br>Duration: %{y:.0f} hours<extra></extra>'
    ), row=3, col=1)
...
def main():
    ...
    # Save as HTML file
    output_file = 'co2_scenarios_dashboard_enhanced.html'
