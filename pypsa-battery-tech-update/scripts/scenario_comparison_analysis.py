...
def load_and_compare_scenarios():
    ...
    # Check if we're in package directory or main project directory
    ...
    networks = {
        '250Mt_CO2_Limit': f'{base_path}/250Mt_CO2_Limit_solved_network.nc' if os.path.exists(f'{base_path}/250Mt_CO2_Limit_solved_network.nc') else f'{base_path}/base_s_1_elec_solved_scenario1_250co2.nc',
        '300Mt_CO2_Limit': f'{base_path}/300Mt_CO2_Limit_solved_network.nc' if os.path.exists(f'{base_path}/300Mt_CO2_Limit_solved_network.nc') else f'{base_path}/base_s_1_elec_solved_scenario2_300co2.nc',
        '500Mt_CO2_Limit': f'{base_path}/500Mt_CO2_Limit_solved_network.nc' if os.path.exists(f'{base_path}/500Mt_CO2_Limit_solved_network.nc') else f'{base_path}/base_s_1_elec_solved_scenario3_500co2.nc'
    }
...
def create_comparison_plots(comparison_data):
    ...
    # Create plots directory - flexible path
    if os.path.exists('outputs/plots'):
        plots_dir = "outputs/plots/scenario_comparison"
    else:
